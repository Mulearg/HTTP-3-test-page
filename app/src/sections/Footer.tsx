      ...
      <div className="container-chrome">
        <div className={styles.inner}>
          ...
          <div className={styles.brand}>
            <img className={styles.logo} src="/assets/logo-white.svg" alt="Rayobyte" width={157} height={30} />
            ...
            <img className={styles.award} src="/assets/award.png" alt="Proxyway award" width={65} height={65} />
          </div>
                      ...
                      <a className={styles.link} href="#">
                        ...
                        {chevron && (
                          <img
                            ...
                            src="/assets/icons/chevron-footer.svg"
                            alt=""
                            width={14}
                            height={14}
                          />
          ...
          <div className={styles.contact}>
            <div className={styles.social}>
              {/* The bordered box ships inside each asset — do not redraw it. */}
              <a href="#" aria-label="Rayobyte on YouTube">
                <img className={styles.socialIcon} src="/assets/youtube.svg" alt="" width={44} height={44} />
              </a>
              <a href="#" aria-label="Rayobyte on X">
                <img className={styles.socialIcon} src="/assets/x.svg" alt="" width={44} height={44} />
              </a>
            </div>
            <h2 className={styles.contactTitle}>{footer.contact.title}</h2>
            <p className={styles.address}>{footer.contact.address}</p>
            <img className={styles.qr} src="/assets/qr.svg" alt="" width={75} height={76} />
          </div>
        </div>
      </div>
    </footer>
