 ...
 * survive without pulling in a highlighter â€” the sample is fixed, so parsing
 * it at runtime would be work for no gain.
 */
export function CodeBlock({ lines, label }: { lines: readonly Token[][]; label?: string }) {
  return (
    <div className={styles.block}>
      <img className={styles.dots} src={`${BASE}assets/icons/code-dots.svg`} alt="" width={47} height={11} />
